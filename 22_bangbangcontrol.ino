...
#define _SERVO_ANGLE_DIFF  255  // Replace with |D - E| degree
...
void loop()
{
  ...
  if (event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(10, 0.5, 0)); //입력 완!
...
float volt_to_distance(int a_value)
{
  ...
  return 701 + -2.33*a_value + 1.94E-03*a_value*a_value; //공식 넣기 완!
}
